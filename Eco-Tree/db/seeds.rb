...
Question.create(description: '¿Cuál es el animal más rápido del mundo?', detail: 'El halcón peregrino en picada, cuando caza efectúa un ataque en picado puede alcanzar más de 300 km/h.' )
...
Question.create(description: '¿Cuál es la edad promedio de un león sin estar en cautiverio?', detail: 'Un león, en estado salvaje, puede vivir en promedio entre 12 y 16 años. En cautiverio pueden llegar a la edad de 25 años.' )
...
Question.create(description: '¿Qué mamifero tiene la mordida más poderosa?', detail: 'La mordida del hipopótamo es la más fuerte de todos los mamíferos, siendo capaz de generar un PSI de 1821.' )
...
Question.create(description: '¿Qué criatura tiene una lengua que puede medir la longitud de su cuerpo?', detail: 'El camaleón es capaz de extender la lengua hasta dos veces del tamaño de su cuerpo.')
...
Question.create(description: '¿Cuál es el pariente vivo más cercano al T-rex?', detail: 'Se demostró que la gallina común y el avestruz comparten más rasgos genéticos con el Tyrannosaurus rex que los reptiles.')
...
Question.create(description: '¿Dónde almacenan las nutrias marinas la comida adicional en sus cuerpos?', detail: 'Las nutrias poseen una piel suelta y flexible, que pueden estirar y utilizar como una especie de bolsa o bolsita para llevar comida')
...
Question.create(description: '¿Cuál es el tipo de energía más contaminante?', detail: 'El carbón y el petróleo son los mayores culpables del efecto invernadero y del cambio climático, provocando no solo la contaminación del aire, sino también de la tierra y del agua.')
...
Item.create(name:'arce', section:'hoja', description: 'Arce', price: 15)
